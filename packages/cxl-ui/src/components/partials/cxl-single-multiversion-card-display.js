...
const CXLSingleMultiversionCardDisplay = (el, postType, userId, selected) => html`
  ...
  >
    <header class="entry-header" slot="summary">
      <label title="${postType === 'minidegree' ? 'Course' : 'Playbook'}" class="entry-type"
        >${postType === 'minidegree' ? 'COURSE' : 'PLAYBOOK'}</label
      >
