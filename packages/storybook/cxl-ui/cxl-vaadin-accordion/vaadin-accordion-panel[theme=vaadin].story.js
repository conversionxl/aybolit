...
export const CXLVaadinAccordionThemeVaadin = () => html`
  <style>
    label {
      display: block;
      font-weight: bold;
  ...
  <vaadin-accordion class="wc_payment_methods">
    <vaadin-accordion-panel class="wc_payment_method payment_method_stripe" theme="reverse vaadin">
      <div slot="summary">
      ...
      <div class="payment_box payment_method_stripe">
        <p>
          ...
          and a valid expiration date or check the
          <a href="https://stripe.com/docs/testing" target="_blank">Testing Stripe documentation</a>
