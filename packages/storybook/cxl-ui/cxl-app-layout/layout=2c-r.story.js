...
export const CXLAppLayout2crContent = ({ hasWidgetBackground }) => html`
  <style>
      ...
      <header class="entry-header">
        <h4 class="entry-title no-anchor" itemprop="headline">
          ...
          <a
            ...
            rel="bookmark"
            itemprop="url"
            ><span data-post-status="publish"></span>Persuasion Psychology: A Brief Introduction</a
          >
        </h4>
      </header>
      <!-- .entry-header -->
      ...
      <header class="entry-header">
        <h4 class="entry-title no-anchor" itemprop="headline">
          ...
          <a
            ...
            rel="bookmark"
            itemprop="url"
            ><span data-post-status="publish"></span>Friction: Imaginary Friction &amp; Cognitive
            Fluency</a
          >
        </h4>
      </header>
  ...
  >
    ...
    <div class="entry-content" itemprop="text">
      ...
      <p>
        ...
        proven&nbsp;to convert prospects across a range of industries, from&nbsp;e-commerce to b2b.
      </p>
      ...
      <p>
        A top-rated domestic and international speaker, Rondeau has spent his entire career working
        on optimization campaigns and has helped train some of the leading optimization teams at
        Fortune 500 companies.
      </p>
      <p>
        Rondeau has run hundreds of tests for both B2B and eCommerce brands and has analyzed 3,000+
        tests across virtually every industry.
      </p>
      <p>
        <a
