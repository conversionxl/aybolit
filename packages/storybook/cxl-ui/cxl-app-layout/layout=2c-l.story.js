...
import '@conversionxl/cxl-ui/src/components/cxl-playbook-progress-bar.js';
...
export const CXLAppLayout2clContent = ({
  hasWidgetBackground,
  postId,
  userId,
  playbookSaved,
  ...
  <section class="widget ${hasWidgetBackground ? 'has-background' : ''}" slot="sidebar">
    ...
    <vaadin-details theme="reverse">
      ...
      <p>
        Wes would rather jump out of a plane than read about what skydiving feels like. Similarly,
        he rather test out a promising software product than read a whitepaper about how
        “life-changing” the product is going to be.
      </p>
      <p>
        Last time Wes checked, he has generated well over 130,000 free trial users since founding
        <a href="https://trafficiscurrency.com">Traffic Is Currency</a>, an agency that specializes
